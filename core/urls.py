...
urlpatterns += [
    ...
    # Temporary: migration trigger; remove after use
    path('admin/tools/run-migrations/', run_migrations, name='run_migrations'),
]